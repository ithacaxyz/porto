  ...
  Type.Object({
    ...
    permissions: Type.Object({
      ...
      signatureVerification: Schema.Optional(
        Type.Object({
          addresses: Type.Readonly(Type.Array(Primitive.Address)),
        }),
      ),
...
export const experimental_prepareCreateAccountParams0 = Type.Object({
  ...
  capabilities: Schema.Optional(
    Type.Object({
      grantPermissions: Permissions.Request,
    }),
  ),
...
export const experimental_prepareCreateAccountReturnType = Type.Object({
  ...
  signPayloads: Type.Readonly(Type.Array(Primitive.Hex)),
})
...
export const experimental_createAccountParams0 = Type.Intersect([
  ...
  Schema.OneOf([
    ...
    Type.Object({
      context: Type.Unknown(),
      signatures: Type.Readonly(Type.Array(Primitive.Hex)),
    }),
  ]),
])
          ...
          logs: Type.Readonly(
            Type.Array(
              Type.Object({
                address: Primitive.Address,
                data: Primitive.Hex,
                topics: Type.Readonly(Type.Array(Primitive.Hex)),
              }),
            ),
          ),
