...
export async function setEmail(
  ...
  >({
    ...
    params: [
      Typebox.Encode(
        ...
        Typebox.Clean(
          RpcSchema.account_setEmail.Parameters,
          parameters satisfies RpcSchema.account_setEmail.Parameters,
        ),
      ),
    ],
  })
  ...
  return Typebox.Decode(
    RpcSchema.account_setEmail.Response,
    response satisfies Typebox.Static<
      typeof RpcSchema.account_setEmail.Response
    >,
  )
}
...
export declare namespace setEmail {
  type Parameters = Typebox.StaticDecode<
    typeof RpcSchema.account_setEmail.Parameters
  >
