...
export const hosts = [
  ['anvil.localhost', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],
  ['app.ens.domains', ['allow-blind-sign', 'allow-safari-iframe']],
  ['app.uniswap.org', ['allow-blind-sign', 'allow-safari-iframe']],
  ['bluestake.vercel.app', ['allow-safari-iframe', 'allow-merchant-rpc']],
  ['bungee.exchange', ['allow-blind-sign', 'allow-safari-iframe']],
  ['cartel.sh', ['allow-safari-iframe']],
  ['cctp.exchange', ['allow-safari-iframe']],
  ['cut-v2.mattlovan.dev', ['allow-merchant-rpc', 'allow-safari-iframe']],
  ['daimo.ngrok.app', ['allow-merchant-rpc', 'allow-safari-iframe']],
  ...
  ['localhost', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],
  ['paper.ink', ['allow-safari-iframe']],
  ['pay.daimo.com', ['allow-safari-iframe']],
  ['playground.li.fi', ['allow-safari-iframe']],
  ['playground.porto.sh', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],
  ['portal.eco.com', ['allow-safari-iframe']],
  ['porto.sh', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],       
  ['preview.porto.sh', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']], 
  ['rath.fi', ['allow-safari-iframe']],
  ['relay.link', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],
  ['sponsor-porto.vercel.app', ['allow-safari-iframe']],
  ['stg.localhost', ['allow-blind-sign', 'allow-merchant-rpc', 'allow-safari-iframe']],
