...
export function Dashboard() {
  ...
  return (
    <React.Fragment>
      <section className="z-50 flex flex-col gap-y-4 overflow-y-auto rounded-3xl bg-stone-50 px-3 py-2 tabular-nums sm:px-6 lg:px-8">
            ...
            <table className="my-3 w-full">
              ...
              <tbody className="border-transparent border-t-10 font-semibold">
                {assets?.map((asset, index) => (
                  ...
                  >
                    <td className={cx('text-left')}>{asset.token.name}</td>
