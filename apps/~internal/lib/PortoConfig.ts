...
const config = {
  ...
  prod: {
    ...
    chains: [base, baseSepolia, bsc, optimism, optimismSepolia],
    feeToken: 'USDC',
    mode: Mode.rpcServer({
      mock,
      persistPreCalls: false,
    ...
    transports: {
      ...
      [bsc.id]: http(undefined, Sentry.httpTransportOptions()),
  ...
  stg: {
    ...
    transports: {
      ...
      [arbitrumSepolia.id]: http(undefined, Sentry.httpTransportOptions()),
      [base.id]: http(undefined, Sentry.httpTransportOptions()),
      [baseSepolia.id]: http(undefined, Sentry.httpTransportOptions()),
      [bsc.id]: http(undefined, Sentry.httpTransportOptions()),
      [optimism.id]: http(undefined, Sentry.httpTransportOptions()),
      [optimismSepolia.id]: http(undefined, Sentry.httpTransportOptions()),
      [polygon.id]: http(undefined, Sentry.httpTransportOptions()),
    },
  },
