...
import { useAccount, useAccountEffect, useConnect, useConnectors } from 'wagmi'
...
function RouteComponent() {
  ...
  const connect = useConnect({
    mutation: {
      onError(error) {
        console.error('auth.tsx, onError', error)
  ...
  useAccountEffect({
    onConnect: (data) => {
      console.info('auth.tsx, onConnect', data)
    },
  })
  ...
  return (
    <React.Suspense fallback={<div>[auth.tsx] Loading...</div>}>
      <Layout>
        <Layout.Content>
