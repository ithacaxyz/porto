  ...
  return (
    <div className="flex h-full w-full items-center justify-center md:h-auto">
      <Ariakit.Form
        ...
        className="flex h-full w-full flex-col items-center justify-between pb-20 md:mb-60 md:h-auto md:min-w-100.5 md:max-w-100.5 md:items-start md:justify-start md:pb-0"
        store={form}
      >
        <header className="mt-24 mb-6 flex max-w-[254px] flex-col items-center gap-1.5 text-center md:mt-0 md:max-w-full md:items-start md:px-2 md:text-left">
          <h2
