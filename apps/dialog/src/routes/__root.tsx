  ...
  return (
    <>
      ...
      <div
        ...
        className="border-primary contain-content data-popup-standalone:mx-auto data-popup-standalone:h-screen data-popup-standalone:max-w-[360px] data-iframe:rounded-[14px] data-popup-standalone:rounded-[14px] data-iframe:border data-popup-standalone:border data-popup-standalone:[@media(min-height:400px)]:mt-8 data-popup-standalone:[@media(min-height:400px)]:h-[310px]"
      >
        <TitleBar
          mode={mode}
          ref={titlebarRef}
