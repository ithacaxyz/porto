...
## How can I try out the Porto browser extension?

The Porto browser extension is available on our [GitHub Releases page](https://github.com/ithacaxyz/porto/releases/latest)
or through a [direct download here]('https://service.porto.workers.dev/extension').
