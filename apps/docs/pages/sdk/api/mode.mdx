...
- [With `Mode.reactNative` (dialog)](https://github.com/ithacaxyz/porto/tree/main/examples/react-native).
- [With `Mode.relay` (headless)](https://github.com/ithacaxyz/porto/tree/main/examples/react-native-relay-mode).
...
[Learn more](https://docs.expo.dev/linking/into-your-app/#test-a-link-using-expo-go).
