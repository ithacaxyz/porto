...
- [`Mode.rpc()`](#TODO): Requests & signing is handled locally, and coordinated with the Porto RPC.

:::warning
Using `Mode.contract()` or `Mode.rpc()` comes with some caveats. Please refer to the [`Mode.contract()`](#TODO) or [`Mode.rpc()`](#TODO) documentation for more information.
:::
