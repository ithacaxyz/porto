...
By default, Porto uses [IndexedDB](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API) in browser environments
and a JavaScript [`Map`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map) in non-browser environments.

## Storage Backends

| Storage | Underlying | Default |
| --------------- | ----------- | ------- |
| `Storage.idb` | [IndexedDB](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API) | in browser |
| `Storage.cookie` | [Cookie](https://developer.mozilla.org/en-US/docs/Web/API/Cookie_API) | |
