...
const connector = porto({
  mode: Mode.dialog({
    features: {
      ...
      // When false, hides "Switch" link in signed-in view
      accountSwitcher: false,  // Default: true

      // When false, hides "Sign up" link in signed-in view
      signUpLink: false,  // Default: true

      // When false, hides "Sign in" button in get started view
      signIn: false,  // Default: true
...
- `accountSwitcher` - Show/hide account switching link
- `signUpLink` - Show/hide sign up link
- `signIn` - Show/hide sign-in button
...
const connector = porto({
  mode: Mode.dialog({
    labels: {
      ...
      continue: 'Continue with passkey',    // Default: "Continue with Porto"
