...
The account and key must exist on-chain, unless it is a [PREP](https://blog.biconomy.io/prep-deep-dive/)  account created through [`wallet_createAccount`](/rpc-server/wallet_createAccount).
