...
## Porto Multi-Chain Support

<ChangelogDate date="2025-08-19" />

Porto is now live in **production** with comprehensive multi-chain support across major Ethereum networks. Build cross-chain applications with seamless transaction routing, optimized fee management, and unified account experiences.

### Supported Networks

**Mainnet (Live Now):**
- **Base** - Native chain integration with fast settlement
- **Optimism** - Full Layer 2 support with OP Stack compatibility  
- **Arbitrum** - Arbitrum One integration with optimized routing
- **BNB Chain** - Native BNB support for broader ecosystem reach
- **Polygon** - POL native asset and USDC support
...
**Enhanced Fee Management:** Pay fees in stablecoins (USDC) or native tokens across all networks with transparent, predictable costs.

**Contract Improvements:** Updated account abstraction contracts with new CBMulticall functionality for more efficient batch operations.
